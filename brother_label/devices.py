...
class BrotherDevicePT_180(BrotherDevice):
    def __init__(self, *args, **kwargs):
        super().__init__(labels=(kwargs.pop('labels', []) + [
            # Endless
...
class BrotherDevicePT_360(BrotherDevice):
    def __init__(self, *args, **kwargs):
        super().__init__(labels=(kwargs.pop('labels', []) + [
            # Endless
            Label(Media.ENDLESS_3_5,    ["pt3.5"],                              (  4,   0), FormFactor.PTOUCH_ENDLESS,  (  48,    0), (  48,    0), 264, feed_margin=14),
            Label(Media.ENDLESS_6,      ["pt6"],                                (  6,   0), FormFactor.PTOUCH_ENDLESS,  (  84,    0), (  64,    0), 256, feed_margin=14),
            Label(Media.ENDLESS_9,      ["pt9"],                                (  9,   0), FormFactor.PTOUCH_ENDLESS,  ( 128,    0), ( 106,    0), 235, feed_margin=14),
            ...
            Label(Media.ENDLESS_24,     ["pt24"],                               ( 24,   0), FormFactor.PTOUCH_ENDLESS,  ( 340,    0), ( 320,    0), 128, feed_margin=14),
...
class BrotherDeviceManager(ElementManager):
    def __init__(self):
        super().__init__((
            ...
            BrotherDevicePT_360('PT-P950NW',    ( 57, 28346), number_bytes_per_row=70),
        ))
